...
- Runs Linux - Red Hat Enterprise Linux 7
...
The DSS has an RStudio Workbench (formerly Pro) license that will allow you to connect to an instance of RStudio (+ Jupyter and VS Code) in your browser while harnessing the computing power of a remote multiprocessor server.
